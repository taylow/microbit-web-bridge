 ...
 */
export function mapQueryString(queryString: string, queryStringFormat: string) {
...
export function processRESTRequest(serialPacket: SerialPacket, responsePacket: SerialPacket, translation: any[], requestType: string): Promise<SerialPacket> {
