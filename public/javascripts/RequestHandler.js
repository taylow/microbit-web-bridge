        ...
        return new Promise((resolve, reject) => {
            ...
            switch (queryStrMap["service"]) {
                ...
                case "weather":
                    ...
                    const route = serialPacket.get(0);
